...
const (
	...
	FlagValueP2PDHTDisabled   = "disabled"
...
func (m *Manager) SetupLocalIPFSFlags(fs *flag.FlagSet) {
	...
	fs.StringVar(&m.Node.Protocol.DHT, FlagNameP2PDHT, FlagValueP2PDHTClient, "dht mode, can be: `client`, `server`, `auto`, `autoserver`") // @TODO(gfanton): add disabled mode
